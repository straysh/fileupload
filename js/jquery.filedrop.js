...
(function($) {
	...
	$.fn.filedrop = function(options) {
			...
			if (e.lengthComputable) {
				...
				if (this.currentProgress !== percentage) {
					...
					if (diffTime >= opts.refresh) {
						...
						var speed = diffData / diffTime; // KB per
						// second
		...
		function upload() {
			...
			if (files.length > opts.maxfiles && opts.queuefiles === 0) {
				opts.error(errors[1]);
				return false;
			}
				...
				try {
					if (beforeEach(files[fileIndex]) !== false) {
						...
						reader.onloadend = !opts.beforeSend ? send : function(e) {
							opts.beforeSend(files[fileIndex], fileIndex, (function(f) {
								return function(){send(e, f)};
							})(files[fileIndex]));
						};

						uploadFiles.push(files[fileIndex]);
